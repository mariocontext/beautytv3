...
<!-- woo slider in child template - Home Page template, not home.php -->

<?php $blog_lang = get_bloginfo('language'); ?>


<?php if($blog_lang === "es-ES") {

wooslider(array('slider_type' => 'slides'), array('slide_page' => 'woo-homepage-slideshow-espanol')); 

} else {

wooslider(array('slider_type' => 'slides'), array('slide_page' => 'woo-homepage-slideshow')); 
} 
